...
final baseEntriesProvider = Provider.family<List<LocalizationEntry>, String>((
  ref,
  fileName,
) {
...
final overridesProvider = StreamProvider.family<Map<String, String>, String>((
  ref,
  fileName,
) {
...
final synthesizedStringsProvider =
    Provider.family<List<LocalizationEntry>, String>((ref, fileName) {
...
final filterModeProvider = NotifierProvider<FilterModeNotifier, FilterMode>(
  FilterModeNotifier.new,
);

/// High-performance filtering with fast-path and pre-indexed case-insensitive comparisons
final filteredStringsProvider =
    Provider.family<List<LocalizationEntry>, String>((ref, fileName) {
