...
void main() {
  ...
  group('CSV Worker Parser & Exporter Tests', () {
    test('parseCsvWorker parses semicolon-delimited War Thunder CSV correctly', () async {
      ...
      expect(result['germ_pzkpfw_VI_ausf_B_tiger_IIh'], equals('"Tiger II (H)"'));
    ...
    test('exportPatchedCsvWorker preserves other language columns and applies overrides', () async {
      ...
      final success = await exportPatchedCsvWorker(ExportTaskParameters(
      ...
      expect(rawTarget.contains('Easy Eight Sherman;M4A3 (76) W;M4A3 (76) W'), isTrue);
    });
  });
}
